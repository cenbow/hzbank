define(['./mui_data', './requestAnimationFrame'], function(){
    ...
    function Counter(element, options) {
        ...
        this.count = function(timestamp) {
            var from = self.from;
            var to = self.to*Math.pow(10,options.toFixed);
            ...
            self.$element.html((val/Math.pow(10,options.toFixed)).toFixed(options.toFixed));
    ...
    $.fn.countable = function (option) {
        ...
        return $(this).each(function () {
            ...
            var data = new Counter(this, options);
