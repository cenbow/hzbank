define(function(require, exports, module){
	...
	var loanquerystep1Tpl = require("text!../template/loanquerystep1.html");
	
	var loanquerystep1View = module.exports = ItemView.extend({
		
        template : loanquerystep1Tpl,
	  ...
	  toforget : function(){
			App.navigate("settings/setCenterCtl/logonPasswordReset");
		},
		...
		getCodeImg : function(){
     	...
     	getPhotoResFront : function(obj){
			...
			App.navigate("houseloan/houseloanCtl/loanquerystep2",this.param);
		},
