define(function(require, exports, module){
	...
	var loanquerystep2Tpl = require("text!../template/loanquerystep2.html");
	
	var loanquerystep2View = module.exports = ItemView.extend({
		
		events : {
			"click #loanquerysure" : "toloanquerysure",
			"click #loanquerycancel" : "toloanquerycancel"
			
		},
		
		template : loanquerystep2Tpl,
			//定义日志TAG便于错误信息查找
		initialize : function(){
			  var pageTest = {
	    			  	title:'贷款进度查询',
		...
		excep : function(obj){
			...
			if(res=="fail"){
				param.res = res;
				param.msg = msg;
				App.navigate("houseloan/houseloanCtl/queryresult?from=ocr",param);
			}else{
				App.navigate("houseloan/houseloanCtl/loanfacecheck",param);
			}
