define(function(require, exports, module){
	...
	var elecAccPwdResetThreeTpl = require("text!../template/elecAccPwdResetThree.html");
	
	var elecAccPwdResetThreeView = module.exports = ItemView.extend({
		
	template : elecAccPwdResetThreeTpl,
	
	events:{
		"click #password1":"password1",
		"click #password2":"password2",
		"keyup #certNoText":"checkButton",
		"blur #certNoText":"checkButton",
