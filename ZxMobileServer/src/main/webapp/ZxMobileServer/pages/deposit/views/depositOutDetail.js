define(function (require, exports, module) {
	...
	var depositOutDetailTemplate = require("text!../template/depositOutDetail.html");
	
	var DepositOutDetailView = module.exports = ItemView.extend({
		
        template : depositOutDetailTemplate,
...
//    		}
    		$("#"+id).append( '<li>'+
    				...
    				'</div>'+
    				'<div class="query-btn">'+
    					'<a href="javascript:;" class="btn" id= "'+accountNo+'" name="'+info+'">转活期</a>'+
    				'</div>'+
    			'</li>');
    		var $this = this;
    		$("#"+accountNo).on('click', function() {
    			$this.depositOut(info);
    		});
    	},
    	
    	depositOut : function(info){
    		...
    		App.navigate("deposit/depositCtl/depositOut",param);
    	},
