define(function(require, exports, module){
	...
	var tuitionPayTpl = require("text!../template/tuitionPay.html");
	var tuitionPayView = module.exports = ItemView.extend({
		...
		initialize : function(){
    		...
    		if((parameter && parameter.cardNo) || parseFloat(tranAmt) > 10000){
        		...
        		if(MUI.isEmpty(iCardList)){
        			...
        			this.queryCardList((parseFloat(tranAmt) > 10000 && !(parameter && parameter.cardNo))?"bind":parameter.cardNo);
        		}else{
        			this.showSelected(iCardList,(parseFloat(tranAmt) > 10000 && !(parameter && parameter.cardNo))?"bind":parameter.cardNo);
        		}
    		}
		...
		submit : function(){
			...
			var parameter = App.storage.get("_parameters");
			var resultUrl = parameter.resultUrl || "fee/feeCtl/result";
			var $this = this;
